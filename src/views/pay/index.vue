<template>
  <div class="pay">
    ...
    <div class="address">
      ...
      <div class="info" v-if="selecteAddress.address_id">
        <div class="info-content">
          <span class="name">{{ selecteAddress.name }}</span>
          <span class="mobile">{{ selecteAddress.phone }}</span>
        </div>
    ...
    <div class="pay-list" v-if="order.goodsList">
      ...
      <div class="pay-detail">
        ...
        <div class="pay-cell">
          <span>配送费用：</span>
          <span v-if="!selecteAddress">请先选择配送地址</span>
...
export default {
  ...
  computed: {
    ...
    longAddress () {
      const region = this.selecteAddress.region
      return region.province + region.city + region.region + this.selecteAddress.detail
    },
    mode () {
